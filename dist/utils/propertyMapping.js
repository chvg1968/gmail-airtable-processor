...
exports.findPropertyMapping = void 0;
...
function findPropertyMapping(accommodationNameFromGemini, propertyCodeVrboFromGemini, platform, airbnbMappings, vrboMappings) {
    if (!platform) {
    ...
    if (lowerPlatform.includes("airbnb")) {
        ...
        const mapping = airbnbMappings.find((m) => {
            ...
            return (lowerAccommodationName.includes(aliasLower) ||
    ...
    else if (lowerPlatform.includes("vrbo") ||
        ...
        if (!candidate && accommodationNameFromGemini) {
            ...
            const matchByAlias = airbnbMappings.find((m) => {
                const aliasLower = m.alias.toLowerCase();
                return (lowerName.includes(aliasLower) || aliasLower.includes(lowerName));
            });
...
exports.findPropertyMapping = findPropertyMapping;
