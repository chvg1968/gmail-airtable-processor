  ...
  const LOCAL_FALLBACK = [
    {
      ...
      aliases: ["Ocean Grace", "Ocean Grace Villa", "Grace"],
    },
    {
      name: "2-101 Ocean Serenity Villa",
      aliases: ["Ocean Serenity", "Ocean Serenity Villa", "Serenity"],
    },
    {
      ...
      aliases: [
        "Ocean Haven",
        "Ocean Haven Villa",
        "Bahia Beach Steps from Ocean 2BDRM- Ocean Haven",
        "Haven",
      ],
    },
    {
      name: "2-103 Ocean Sound Villa",
      aliases: ["Ocean Sound", "Ocean Sound Villa", "Sound"],
    },
    {
      name: "315 Ocean View Villa",
      aliases: ["Ocean View", "Ocean View Villa", "View"],
    },
  ...
  function tryMatchByAliases(text) {
    ...
    for (const p of LOCAL_FALLBACK) {
      for (const alias of p.aliases) {
        if (clean.includes(normalize(alias)))
          return { name: p.name, aliasMatched: alias };
      }
    }
    return null;
  }
