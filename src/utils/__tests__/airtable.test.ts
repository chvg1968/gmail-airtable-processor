...
describe('upsertBookingToAirtable', () => {
  ...
  describe('para reservas de Vrbo', () => {
    it('debe establecer NeedsDateReview como false independientemente de las fechas', async () => {
      ...
      const result1 = await upsertBookingToAirtable(testData1, mockConfig);
      const result2 = await upsertBookingToAirtable(testData2, mockConfig);
      const result3 = await upsertBookingToAirtable(testData3, mockConfig);
